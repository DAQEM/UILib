...
public class Textures {
    ...
    public static final NineSlicedTexture BUTTON = new NineSlicedTexture(GUI_TEXTURES, 0, 0, 9, 9, 4);
    public static final NineSlicedTexture TAB = new NineSlicedTexture(GUI_TEXTURES, 0, 9, 9, 9, 4);
