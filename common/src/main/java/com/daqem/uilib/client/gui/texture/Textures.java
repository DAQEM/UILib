...
public class Textures {
    ...
    public static final NineSlicedTexture MINECRAFT_BUTTON = new NineSlicedTexture(ResourceLocation.parse("textures/gui/widgets.png"), 0, 66, 200, 20, 20, 4);
    public static final NineSlicedTexture MINECRAFT_BUTTON_HOVERED = new NineSlicedTexture(ResourceLocation.parse("textures/gui/widgets.png"), 0, 86, 200, 20, 20, 4);
    ...
    public static class Advancement {
        private static final ResourceLocation ADVANCEMENT_WIDGETS_LOC = ResourceLocation.parse("textures/gui/advancements/widgets.png");
        private static final ResourceLocation ADVANCEMENT_WINDOW_LOC = ResourceLocation.parse("textures/gui/advancements/window.png");
